...
export default function ProductDetail({ product }) {
  const [selectedColor, setSelectedColor] = useState(productMock.colors[0])
  const [selectedSize, setSelectedSize] = useState(productMock.sizes[2])
        ...
        <div className="pt-6">
          ...
          <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
            <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
              <div className="max-w-2xl mt-6 lg:grid ">
                <Image
                  alt={product.name}
                  src={product.image.link}
                  className="object-cover rounded-lg size-full lg:block"
                  width={200}
                  height={200}
                />
              </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              <h1 className="mt-6 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{product.name}</h1>

              <h2 className="mt-8 sr-only">Product information</h2>
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-sm text-gray-600">Aqui van unos details</p>
                </div>
              </div>
            </div>
          </div>
